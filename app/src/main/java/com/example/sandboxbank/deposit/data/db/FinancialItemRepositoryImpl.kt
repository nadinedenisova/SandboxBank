...
import com.example.sandboxbank.deposit.domain.db.FinancialItemRepository
import com.example.sandboxbank.deposit.domain.model.FinancialItem
import kotlinx.coroutines.flow.Flow
import kotlinx.coroutines.flow.map

class FinancialItemRepositoryImpl(private val financialItemDao: FinancialItemDao,
                                  private val converter: FinancialItemDbConverter): FinancialItemRepository {
